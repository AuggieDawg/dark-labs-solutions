export const ENGAGEMENTS = [
  {
    ...
    includes: [
      ...
      "Technical risks, dependencies, ownership, and recurring-cost map",
      "Measurement recommendations and launch criteria",
  ...
  },
  {
    ...
    includes: [
      ...
      "Documented ownership, client access, costs, and handoff responsibilities",
    ],
  ...
  },
  {
    ...
    includes: [
      ...
      "End-to-end lead-delivery and failure-path testing",
  ...
  },
  {
    ...
    summary:
      "Ongoing improvement for a live acquisition system using honest measurement, operational feedback, and a prioritized experiment backlog.",
    includes: [
      ...
      "Clear reporting on what is working, uncertain, or broken",
